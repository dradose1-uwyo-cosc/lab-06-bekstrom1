...
# Lab 06
# Lab Section: 13
# Sources, people worked with, help given to: Nolan Hottell, Riley Green
...
least_occured = min(letter_count, key=letter_count.get)


print(f"The letter that occurred the most is {most_occurred}")
print("*"*75)
# Output which letter occurred the least
print(f"The letter that occurred the most is {least_occured}")
print("*"*75)
